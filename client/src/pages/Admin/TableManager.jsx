...
export default function TableManager() {
  ...
  const handleSave = async () => {
    ...
    return res.status(409).json({ error: `Table number ${number} already exists.` });
  }
    ...
    <AdminLayout title="Table Manager">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        {[
          ...
          {
            label: "Occupied",
            count: statusGroups.occupied,
            color: "text-blue-600",
            bg: "bg-blue-50",
          },
          {
            label: "Bill Needed",
            count: statusGroups.bill_requested,
  ...
  {table.location
    ...
    : "Unspecified"}
        ...
        <div className="space-y-4">
          ...
          {!editing && (
            <p className="text-xs text-gray-400 bg-blue-50 border border-blue-100 rounded-xl px-3 py-2">
              💡 A QR code will be automatically generated when you create this
              table.
            </p>
          )}
        ...
        {qrModal && (
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-xs text-gray-400 text-center">
              Customers scan this QR code to access the digital menu for Table{" "}
              {qrModal.number}
            </p>
            <div className="flex gap-3 w-full">
              ...
              >
                <RefreshCw
                  size={14}
                  className={regenId === qrModal._id ? "animate-spin" : ""}
                />
                Regenerate
              </button>
              <button
            ...
            <p className="text-xs text-amber-600 bg-amber-50 border border-amber-100 rounded-xl px-3 py-2 text-center">
              ⚠️ Regenerating invalidates the old printed QR code for this
              table.
            </p>
          </div>
        )}
      ...
      <ConfirmDialog
        ...
        loading={deleting}
        title="Delete Table?"
        message="This will remove the table and its QR code permanently."
        confirmLabel="Delete"
        danger
      />
    </AdminLayout>
